...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        nav.site-nav { background: #1e3a8a; padding: 14px 40px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; }
        nav.site-nav .brand { color: #fff; font-weight: bold; font-size: 18px; }
        nav.site-nav ul { list-style: none; display: flex; gap: 20px; margin: 0; padding: 0; }
